...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "html {\n    --icons-filter-value: invert(100%) sepia(0%) saturate(0%) hue-rotate(188deg) brightness(102%) contrast(105%);\n    --outer-padding-value: 2rem;\n    --margin-value: 2rem;\n    --add-button-background: rgb(99, 168, 99);\n    /* --header-background: rgb(223, 168, 101); */\n    --header-background: rgba(227, 157, 70, 0.85);\n    --low-priority-bg: rgba(169, 241, 169, 0.699);\n    --medium-priority-bg: rgb(235, 235, 134);\n    --high-priority-bg: rgb(252, 133, 133);\n    /* --header-background: #65A30D; */\n    /* --header-background: #FDBA74;\n    --add-button-background: #FB923C; */\n}\n\nbody {\n    height: 100vh;\n    margin: 0;\n    display: grid;\n    grid-template-rows: min-content 1fr min-content;\n    grid-template-columns: 300px 1fr;\n    font-size: 12px;\n    font-family: sans-serif, serif;\n}\n\n/* body > * {\n    border: 1px solid black;\n} */\n\n.header, .footer {\n    grid-column: 1 / 3;\n}\n\n.footer { \n    padding: 1.5rem;\n    font-size: 1.2rem;\n    background-color: rgb(204, 204, 204);\n }\n\n.header {\n    font-size: 2rem;\n    font-weight: bold;\n    padding: 1.5rem var(--outer-padding-value);\n    color: white;\n    background-color: var(--header-background);\n}\n\n.sidebar {\n    grid-column: 1;\n    padding-left: var(--outer-padding-value);\n    padding-right: var(--outer-padding-value);\n    padding-top: var(--outer-padding-value);\n    background-color:#f9e1b391;\n}\n\n.currents {\n    display: grid;\n    grid-template-rows: auto auto;\n    row-gap: 1rem;\n}\n\n.sidebar .currents > div {\n    font-size: 1.1rem;\n    padding: 0.5rem 0.3rem;\n    border-radius: 0.2rem;\n}\n\n.sidebar .currents div:last-child {\n    margin-bottom: 1rem;\n}\n\n.sidebar .projects {\n    font-weight: bold;\n    font-size: 1.2rem;\n}\n\n.sidebar .projects div {\n    font-size: 1.1rem;\n    font-weight: normal;\n    display: grid;\n    grid-template-columns: 1fr min-content;\n    column-gap: 0.4rem;\n    word-break: break-all;\n    align-items: center;\n    margin-bottom: 1rem;\n    padding: 0.3rem 0.3rem;\n    border-radius: 0.2rem;\n}\n\n.sidebar .projects div:hover,\n.sidebar .currents div:hover {\n    transform: scale(1.02);\n    cursor: pointer;\n    background-color: rgba(199, 199, 199, 0.836);\n}\n\n.sidebar .projects div:active,\n.sidebar .currents div:active {\n    transform: scale(1);\n}\n\n.projects div:first-child {\n    margin-top: 1rem;\n}\n\n.addButton,\n.sidebar .addProjectForm {\n    margin-top: 3rem;\n}\n\n.sidebar .projects .deleteProjectButton {\n    width: 2rem;\n}\n\n.sidebar .addButton {\n    font-size: 1.1rem;\n    font-weight: bold;\n    color: white;\n    background-color: var(--add-button-background);\n    padding: 0.8rem 0.5rem;\n    border-radius: 0.2rem;\n}\n\n.sidebar .addButton > div {\n    display: grid;\n    grid-template-columns: min-content max-content;\n    justify-content: space-around;\n}\n\n.sidebar .addButton img {\n    filter: var(--icons-filter-value);\n}\n\n.sidebar .addButton:active {\n    transform: scale(0.95);\n}\n\n.sidebar .addProjectForm {\n    display: grid;\n    grid-template-rows: min-content min-content;\n}\n\n.sidebar .addProjectForm input {\n    width: 100%;\n    font-size: 1rem;\n    height: 1.8rem;\n    border-style: none;\n    background-color: rgb(189, 223, 189);\n    margin-bottom: 0.5rem;\n    border-radius: 0.2rem;\n    padding-left: 0.5rem;\n    justify-self: center;\n\n}\n\n.sidebar .addProjectForm .buttons {\n    display: flex;\n}\n\n.sidebar .addProjectForm .buttons > * {\n    flex: 1 1 0;\n    padding: 0.3rem 0.2rem;\n    font-size: 1rem;\n    color: rgb(87, 87, 87);\n}\n\n\n.content {\n    grid-column: 2;\n    padding-left: var(--outer-padding-value);\n    padding-top: var(--outer-padding-value);\n    padding-right: var(--outer-padding-value);\n}\n\n.content .addItemForm {\n    width: clamp(500px, 50vw, 720px);\n    position: fixed;\n    top: 40%;\n    left: 50%;\n    transform: translate(-50%, -50%);\n    padding: 1rem;\n    background-color: white;\n    border: 2px solid black;\n    border-radius: 1rem;\n    box-sizing: border-box;\n    z-index: 10;\n    font-size: inherit;\n}\n\n.content #overlay {\n    position: fixed;\n    background-color: rgba(0,0,0,0.6);\n    top: 0;\n    left: 0;\n    bottom: 0;\n    right: 0;\n    z-index: 5;\n    opacity: 0;\n    pointer-events: none;\n    transition: 50ms ease-in-out;\n}\n\n#overlay.active {\n    pointer-events: all;\n    opacity: 1;\n}\n\n.addItemForm .row {\n    margin: 1rem 0;\n}\n\n.addItemForm textarea#desc {\n    resize: vertical;\n    min-height: 60px;\n    max-height: 300px;\n}\n\n.addItemForm .row:nth-child(-n+2) label {\n    display: none;\n}\n\n.addItemForm .row input,\n.addItemForm .row textarea {\n    width: 90%;\n    height: 1.3rem;\n    border-style: none;\n    border: 1px solid lightgray;\n    border-radius: 0.5rem;\n}\n\n.addItemForm .row:nth-child(3) input {\n    width: max-content;\n}\n\n.addItemForm label[for=\"date\"], \n.radioLabel {\n    display: inline-block;\n    width:50px;\n}\n\n.addItemForm .row:nth-child(3) {\n    display: flex;\n    align-items: center;\n}\n\n.priorityRow {\n    display: flex;\n    align-items: center;\n    margin-left: 2rem;\n}\n\n.content .addButton {\n    margin-top: 3rem;\n    padding: 1rem;\n    width: 2rem;\n    background-color: var(--add-button-background);\n    color: white;\n    font-weight: bold;\n    text-align: center;\n    border-radius: 20%;\n\n}\n\n.content .addButton img {\n    filter: var(--icons-filter-value);\n}\n\n.content .addButton:hover {\n    cursor: pointer;\n    transform: scale(1.03);\n}\n\n.content .projectTitle {\n    font-size: 1.5rem;\n    margin-bottom: 1rem;\n}\n\n.toDos {\n    display: flex;\n    flex-direction: column;\n    row-gap: 1rem;\n}\n\n.toDos > div {\n    display: grid;\n    grid-template-rows: auto auto;\n    max-width: 1000px;\n    padding: 0.8rem 0.4rem;\n    border-radius: 0.5rem;\n}\n\n/* style each toDo item */\n.toDos > div > div:first-child {\n    display: flex;\n    column-gap: 20px;\n    align-items: center;\n}\n\n.low {\n    background-color: var(--low-priority-bg);\n}\n\n.medium {\n    background-color: var(--medium-priority-bg);\n}\n\n.high {\n    background-color: var(--high-priority-bg);\n}\n\n.toDos > div {\n    font-size: 1.1rem;\n}\n\n.toDos > div .title {\n    flex: 1;\n    max-width: 600px;\n}\n\n.toDos > div .title:hover {\n    cursor: pointer;\n}\n\n.toDos > div img {\n    width: 2rem;\n}\n\n.toDos > div img:hover {\n    cursor: pointer;\n    transform: scale(1.3);\n}\n\n.toDos > div .edit:active,\n.toDos > div .delete:active {\n    transform: scale(0.95);\n}\n\n.toDos > div .desc {\n    margin-left: 2.5rem;\n    color: darkslategray;\n    font-size: 0.9rem;\n    max-width: 600px;\n}\n\n.footer {\n    text-align: center;\n}", "",{"version":3,"sources":["webpack://./src/css/style.css"],"names":[],"mappings":"AAAA;IACI,4GAA4G;IAC5G,2BAA2B;IAC3B,oBAAoB;IACpB,yCAAyC;IACzC,6CAA6C;IAC7C,6CAA6C;IAC7C,6CAA6C;IAC7C,wCAAwC;IACxC,sCAAsC;IACtC,kCAAkC;IAClC;uCACmC;AACvC;;AAEA;IACI,aAAa;IACb,SAAS;IACT,aAAa;IACb,+CAA+C;IAC/C,gCAAgC;IAChC,eAAe;IACf,8BAA8B;AAClC;;AAEA;;GAEG;;AAEH;IACI,kBAAkB;AACtB;;AAEA;IACI,eAAe;IACf,iBAAiB;IACjB,oCAAoC;CACvC;;AAED;IACI,eAAe;IACf,iBAAiB;IACjB,0CAA0C;IAC1C,YAAY;IACZ,0CAA0C;AAC9C;;AAEA;IACI,cAAc;IACd,wCAAwC;IACxC,yCAAyC;IACzC,uCAAuC;IACvC,0BAA0B;AAC9B;;AAEA;IACI,aAAa;IACb,6BAA6B;IAC7B,aAAa;AACjB;;AAEA;IACI,iBAAiB;IACjB,sBAAsB;IACtB,qBAAqB;AACzB;;AAEA;IACI,mBAAmB;AACvB;;AAEA;IACI,iBAAiB;IACjB,iBAAiB;AACrB;;AAEA;IACI,iBAAiB;IACjB,mBAAmB;IACnB,aAAa;IACb,sCAAsC;IACtC,kBAAkB;IAClB,qBAAqB;IACrB,mBAAmB;IACnB,mBAAmB;IACnB,sBAAsB;IACtB,qBAAqB;AACzB;;AAEA;;IAEI,sBAAsB;IACtB,eAAe;IACf,4CAA4C;AAChD;;AAEA;;IAEI,mBAAmB;AACvB;;AAEA;IACI,gBAAgB;AACpB;;AAEA;;IAEI,gBAAgB;AACpB;;AAEA;IACI,WAAW;AACf;;AAEA;IACI,iBAAiB;IACjB,iBAAiB;IACjB,YAAY;IACZ,8CAA8C;IAC9C,sBAAsB;IACtB,qBAAqB;AACzB;;AAEA;IACI,aAAa;IACb,8CAA8C;IAC9C,6BAA6B;AACjC;;AAEA;IACI,iCAAiC;AACrC;;AAEA;IACI,sBAAsB;AAC1B;;AAEA;IACI,aAAa;IACb,2CAA2C;AAC/C;;AAEA;IACI,WAAW;IACX,eAAe;IACf,cAAc;IACd,kBAAkB;IAClB,oCAAoC;IACpC,qBAAqB;IACrB,qBAAqB;IACrB,oBAAoB;IACpB,oBAAoB;;AAExB;;AAEA;IACI,aAAa;AACjB;;AAEA;IACI,WAAW;IACX,sBAAsB;IACtB,eAAe;IACf,sBAAsB;AAC1B;;;AAGA;IACI,cAAc;IACd,wCAAwC;IACxC,uCAAuC;IACvC,yCAAyC;AAC7C;;AAEA;IACI,gCAAgC;IAChC,eAAe;IACf,QAAQ;IACR,SAAS;IACT,gCAAgC;IAChC,aAAa;IACb,uBAAuB;IACvB,uBAAuB;IACvB,mBAAmB;IACnB,sBAAsB;IACtB,WAAW;IACX,kBAAkB;AACtB;;AAEA;IACI,eAAe;IACf,iCAAiC;IACjC,MAAM;IACN,OAAO;IACP,SAAS;IACT,QAAQ;IACR,UAAU;IACV,UAAU;IACV,oBAAoB;IACpB,4BAA4B;AAChC;;AAEA;IACI,mBAAmB;IACnB,UAAU;AACd;;AAEA;IACI,cAAc;AAClB;;AAEA;IACI,gBAAgB;IAChB,gBAAgB;IAChB,iBAAiB;AACrB;;AAEA;IACI,aAAa;AACjB;;AAEA;;IAEI,UAAU;IACV,cAAc;IACd,kBAAkB;IAClB,2BAA2B;IAC3B,qBAAqB;AACzB;;AAEA;IACI,kBAAkB;AACtB;;AAEA;;IAEI,qBAAqB;IACrB,UAAU;AACd;;AAEA;IACI,aAAa;IACb,mBAAmB;AACvB;;AAEA;IACI,aAAa;IACb,mBAAmB;IACnB,iBAAiB;AACrB;;AAEA;IACI,gBAAgB;IAChB,aAAa;IACb,WAAW;IACX,8CAA8C;IAC9C,YAAY;IACZ,iBAAiB;IACjB,kBAAkB;IAClB,kBAAkB;;AAEtB;;AAEA;IACI,iCAAiC;AACrC;;AAEA;IACI,eAAe;IACf,sBAAsB;AAC1B;;AAEA;IACI,iBAAiB;IACjB,mBAAmB;AACvB;;AAEA;IACI,aAAa;IACb,sBAAsB;IACtB,aAAa;AACjB;;AAEA;IACI,aAAa;IACb,6BAA6B;IAC7B,iBAAiB;IACjB,sBAAsB;IACtB,qBAAqB;AACzB;;AAEA,yBAAyB;AACzB;IACI,aAAa;IACb,gBAAgB;IAChB,mBAAmB;AACvB;;AAEA;IACI,wCAAwC;AAC5C;;AAEA;IACI,2CAA2C;AAC/C;;AAEA;IACI,yCAAyC;AAC7C;;AAEA;IACI,iBAAiB;AACrB;;AAEA;IACI,OAAO;IACP,gBAAgB;AACpB;;AAEA;IACI,eAAe;AACnB;;AAEA;IACI,WAAW;AACf;;AAEA;IACI,eAAe;IACf,qBAAqB;AACzB;;AAEA;;IAEI,sBAAsB;AAC1B;;AAEA;IACI,mBAAmB;IACnB,oBAAoB;IACpB,iBAAiB;IACjB,gBAAgB;AACpB;;AAEA;IACI,kBAAkB;AACtB","sourcesContent":["html {\n    --icons-filter-value: invert(100%) sepia(0%) saturate(0%) hue-rotate(188deg) brightness(102%) contrast(105%);\n    --outer-padding-value: 2rem;\n    --margin-value: 2rem;\n    --add-button-background: rgb(99, 168, 99);\n    /* --header-background: rgb(223, 168, 101); */\n    --header-background: rgba(227, 157, 70, 0.85);\n    --low-priority-bg: rgba(169, 241, 169, 0.699);\n    --medium-priority-bg: rgb(235, 235, 134);\n    --high-priority-bg: rgb(252, 133, 133);\n    /* --header-background: #65A30D; */\n    /* --header-background: #FDBA74;\n    --add-button-background: #FB923C; */\n}\n\nbody {\n    height: 100vh;\n    margin: 0;\n    display: grid;\n    grid-template-rows: min-content 1fr min-content;\n    grid-template-columns: 300px 1fr;\n    font-size: 12px;\n    font-family: sans-serif, serif;\n}\n\n/* body > * {\n    border: 1px solid black;\n} */\n\n.header, .footer {\n    grid-column: 1 / 3;\n}\n\n.footer { \n    padding: 1.5rem;\n    font-size: 1.2rem;\n    background-color: rgb(204, 204, 204);\n }\n\n.header {\n    font-size: 2rem;\n    font-weight: bold;\n    padding: 1.5rem var(--outer-padding-value);\n    color: white;\n    background-color: var(--header-background);\n}\n\n.sidebar {\n    grid-column: 1;\n    padding-left: var(--outer-padding-value);\n    padding-right: var(--outer-padding-value);\n    padding-top: var(--outer-padding-value);\n    background-color:#f9e1b391;\n}\n\n.currents {\n    display: grid;\n    grid-template-rows: auto auto;\n    row-gap: 1rem;\n}\n\n.sidebar .currents > div {\n    font-size: 1.1rem;\n    padding: 0.5rem 0.3rem;\n    border-radius: 0.2rem;\n}\n\n.sidebar .currents div:last-child {\n    margin-bottom: 1rem;\n}\n\n.sidebar .projects {\n    font-weight: bold;\n    font-size: 1.2rem;\n}\n\n.sidebar .projects div {\n    font-size: 1.1rem;\n    font-weight: normal;\n    display: grid;\n    grid-template-columns: 1fr min-content;\n    column-gap: 0.4rem;\n    word-break: break-all;\n    align-items: center;\n    margin-bottom: 1rem;\n    padding: 0.3rem 0.3rem;\n    border-radius: 0.2rem;\n}\n\n.sidebar .projects div:hover,\n.sidebar .currents div:hover {\n    transform: scale(1.02);\n    cursor: pointer;\n    background-color: rgba(199, 199, 199, 0.836);\n}\n\n.sidebar .projects div:active,\n.sidebar .currents div:active {\n    transform: scale(1);\n}\n\n.projects div:first-child {\n    margin-top: 1rem;\n}\n\n.addButton,\n.sidebar .addProjectForm {\n    margin-top: 3rem;\n}\n\n.sidebar .projects .deleteProjectButton {\n    width: 2rem;\n}\n\n.sidebar .addButton {\n    font-size: 1.1rem;\n    font-weight: bold;\n    color: white;\n    background-color: var(--add-button-background);\n    padding: 0.8rem 0.5rem;\n    border-radius: 0.2rem;\n}\n\n.sidebar .addButton > div {\n    display: grid;\n    grid-template-columns: min-content max-content;\n    justify-content: space-around;\n}\n\n.sidebar .addButton img {\n    filter: var(--icons-filter-value);\n}\n\n.sidebar .addButton:active {\n    transform: scale(0.95);\n}\n\n.sidebar .addProjectForm {\n    display: grid;\n    grid-template-rows: min-content min-content;\n}\n\n.sidebar .addProjectForm input {\n    width: 100%;\n    font-size: 1rem;\n    height: 1.8rem;\n    border-style: none;\n    background-color: rgb(189, 223, 189);\n    margin-bottom: 0.5rem;\n    border-radius: 0.2rem;\n    padding-left: 0.5rem;\n    justify-self: center;\n\n}\n\n.sidebar .addProjectForm .buttons {\n    display: flex;\n}\n\n.sidebar .addProjectForm .buttons > * {\n    flex: 1 1 0;\n    padding: 0.3rem 0.2rem;\n    font-size: 1rem;\n    color: rgb(87, 87, 87);\n}\n\n\n.content {\n    grid-column: 2;\n    padding-left: var(--outer-padding-value);\n    padding-top: var(--outer-padding-value);\n    padding-right: var(--outer-padding-value);\n}\n\n.content .addItemForm {\n    width: clamp(500px, 50vw, 720px);\n    position: fixed;\n    top: 40%;\n    left: 50%;\n    transform: translate(-50%, -50%);\n    padding: 1rem;\n    background-color: white;\n    border: 2px solid black;\n    border-radius: 1rem;\n    box-sizing: border-box;\n    z-index: 10;\n    font-size: inherit;\n}\n\n.content #overlay {\n    position: fixed;\n    background-color: rgba(0,0,0,0.6);\n    top: 0;\n    left: 0;\n    bottom: 0;\n    right: 0;\n    z-index: 5;\n    opacity: 0;\n    pointer-events: none;\n    transition: 50ms ease-in-out;\n}\n\n#overlay.active {\n    pointer-events: all;\n    opacity: 1;\n}\n\n.addItemForm .row {\n    margin: 1rem 0;\n}\n\n.addItemForm textarea#desc {\n    resize: vertical;\n    min-height: 60px;\n    max-height: 300px;\n}\n\n.addItemForm .row:nth-child(-n+2) label {\n    display: none;\n}\n\n.addItemForm .row input,\n.addItemForm .row textarea {\n    width: 90%;\n    height: 1.3rem;\n    border-style: none;\n    border: 1px solid lightgray;\n    border-radius: 0.5rem;\n}\n\n.addItemForm .row:nth-child(3) input {\n    width: max-content;\n}\n\n.addItemForm label[for=\"date\"], \n.radioLabel {\n    display: inline-block;\n    width:50px;\n}\n\n.addItemForm .row:nth-child(3) {\n    display: flex;\n    align-items: center;\n}\n\n.priorityRow {\n    display: flex;\n    align-items: center;\n    margin-left: 2rem;\n}\n\n.content .addButton {\n    margin-top: 3rem;\n    padding: 1rem;\n    width: 2rem;\n    background-color: var(--add-button-background);\n    color: white;\n    font-weight: bold;\n    text-align: center;\n    border-radius: 20%;\n\n}\n\n.content .addButton img {\n    filter: var(--icons-filter-value);\n}\n\n.content .addButton:hover {\n    cursor: pointer;\n    transform: scale(1.03);\n}\n\n.content .projectTitle {\n    font-size: 1.5rem;\n    margin-bottom: 1rem;\n}\n\n.toDos {\n    display: flex;\n    flex-direction: column;\n    row-gap: 1rem;\n}\n\n.toDos > div {\n    display: grid;\n    grid-template-rows: auto auto;\n    max-width: 1000px;\n    padding: 0.8rem 0.4rem;\n    border-radius: 0.5rem;\n}\n\n/* style each toDo item */\n.toDos > div > div:first-child {\n    display: flex;\n    column-gap: 20px;\n    align-items: center;\n}\n\n.low {\n    background-color: var(--low-priority-bg);\n}\n\n.medium {\n    background-color: var(--medium-priority-bg);\n}\n\n.high {\n    background-color: var(--high-priority-bg);\n}\n\n.toDos > div {\n    font-size: 1.1rem;\n}\n\n.toDos > div .title {\n    flex: 1;\n    max-width: 600px;\n}\n\n.toDos > div .title:hover {\n    cursor: pointer;\n}\n\n.toDos > div img {\n    width: 2rem;\n}\n\n.toDos > div img:hover {\n    cursor: pointer;\n    transform: scale(1.3);\n}\n\n.toDos > div .edit:active,\n.toDos > div .delete:active {\n    transform: scale(0.95);\n}\n\n.toDos > div .desc {\n    margin-left: 2.5rem;\n    color: darkslategray;\n    font-size: 0.9rem;\n    max-width: 600px;\n}\n\n.footer {\n    text-align: center;\n}"],"sourceRoot":""}]);
// Exports
...
/* harmony import */ var _assets_icons_edit_svgrepo_com_svg__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./assets/icons/edit-svgrepo-com.svg */ "./src/assets/icons/edit-svgrepo-com.svg");
/* harmony import */ var _assets_icons_trash_svgrepo_com_svg__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./assets/icons/trash-svgrepo-com.svg */ "./src/assets/icons/trash-svgrepo-com.svg");
/* harmony import */ var _assets_icons_date_svgrepo_com_svg__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./assets/icons/date-svgrepo-com.svg */ "./src/assets/icons/date-svgrepo-com.svg");
/* harmony import */ var _assets_icons_priority_svgrepo_com_svg__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./assets/icons/priority-svgrepo-com.svg */ "./src/assets/icons/priority-svgrepo-com.svg");
...
const displayController = (() => {
    ...
    const editToDo = (projectId, todoId, item) => {
        ...
        const formattedDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_6__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_7__["default"])(item.dueDate, 1), "MMM dd yy");
    ...
    const createActionItemButton = (projectId, itemId, textC) => {
        ...
        const icon = new Image();
        if(textC === "Delete") {
            icon.src = _assets_icons_trash_svgrepo_com_svg__WEBPACK_IMPORTED_MODULE_3__;
            div.classList.add("delete");
            div.appendChild(icon);
        }
        else {
            icon.src = _assets_icons_edit_svgrepo_com_svg__WEBPACK_IMPORTED_MODULE_2__;
...
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! date-fns */ "./node_modules/date-fns/esm/isYesterday/index.js");
...
const projectFactory = (name) => {
    ...
    const getThisWeekItems = () => {
        ...
        for (let i = 0; i < toDos.length; i++) {
            let dueDate = toDos[i].getDueDate();
            if ((0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(dueDate, 1))) {
...
const toDoModule = (() => {
    ...
    const addToProject = (projectId, item) => {
        ...
        const toDo = (0,_toDo__WEBPACK_IMPORTED_MODULE_1__.toDoFactory)(id, title, description, dueDate, priority, status);
...
/***/ "./src/assets/icons/date-svgrepo-com.svg":
/*!***********************************************!*\
  !*** ./src/assets/icons/date-svgrepo-com.svg ***!
  \***********************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "e862e3df7c462d0c8c79.svg";
...
module.exports = __webpack_require__.p + "0e0856e762d6f54eb2d3.svg";
...
/***/ "./src/assets/icons/priority-svgrepo-com.svg":
/*!***************************************************!*\
  !*** ./src/assets/icons/priority-svgrepo-com.svg ***!
  \***************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
/***/ "./src/assets/icons/trash-svgrepo-com.svg":
/*!************************************************!*\
  !*** ./src/assets/icons/trash-svgrepo-com.svg ***!
  \************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "13e8a97c20d9d3494a21.svg";
...
const logicController = (() => {
    ...
    const openToday = (event) => {
        ...
        const projectAndToDos = _toDoModule__WEBPACK_IMPORTED_MODULE_1__.toDoModule.getTodayItems();
        ...
        for (let i = 0; i < projectAndToDos.length; i++) {
            ...
            // });
            const toDoNodes = _displayController__WEBPACK_IMPORTED_MODULE_2__.displayController.viewProject(projectAndToDos[i].items, projectId);
    ...
    const openThisWeek = (event) => {
        ...
        const projectAndToDos = _toDoModule__WEBPACK_IMPORTED_MODULE_1__.toDoModule.getThisWeekItems();
        for (let i = 0; i < projectAndToDos.length; i++) {
            let projectId = projectAndToDos[i].projectId;
            const toDoNodes = _displayController__WEBPACK_IMPORTED_MODULE_2__.displayController.viewProject(projectAndToDos[i].items, projectId);
            toDoNodes.forEach(addActionListeners);
    ...
    const initializeApp = () => {
        const projectsAndToDos = _storage__WEBPACK_IMPORTED_MODULE_3__.storageController.initializeApp();
        ...
        for (let projectId in projectsAndToDos) {
            ...
            for (let itemId in projectsAndToDos[projectId]["items"]) {
                ...
                _toDoModule__WEBPACK_IMPORTED_MODULE_1__.toDoModule.addToProject(projectId, item);
            }
        }
    };
    ...
    const addProject = (projectName, initial=false) => {
        ...
        if (initial === false) {
            _storage__WEBPACK_IMPORTED_MODULE_3__.storageController.addProject(projectName, projectId);
        }
        ...
        project.querySelector(".deleteProjectButton").addEventListener('click', (event) => {
            ...
            _storage__WEBPACK_IMPORTED_MODULE_3__.storageController.removeProject(projectId);
            event.stopPropagation();
        });
        return project;
    };
    ...
    const openProject = (event) => {
        ...
        const toDos = _toDoModule__WEBPACK_IMPORTED_MODULE_1__.toDoModule.viewProject(projectId);
        // display the project to Do items in the DOM
        const toDoNodes = _displayController__WEBPACK_IMPORTED_MODULE_2__.displayController.viewProject(toDos, projectId, _toDoModule__WEBPACK_IMPORTED_MODULE_1__.toDoModule.getProjectName(projectId));
    ...
    const renderAddItemForm = (projectId) => {
        ...
        _displayController__WEBPACK_IMPORTED_MODULE_2__.displayController.toggleOverlay();
    ...
    const addItemToProject = (projectId, form) => {
        ...
        _storage__WEBPACK_IMPORTED_MODULE_3__.storageController.addToProject(projectId, itemId, item);
    ...
    const toggleItemStatus = (event) => {
        ...
        _storage__WEBPACK_IMPORTED_MODULE_3__.storageController.toggleItemStatus(projectId, itemId);
        _displayController__WEBPACK_IMPORTED_MODULE_2__.displayController.toggleItemStatus(projectId, itemId);
    };
    ...
    const toggleDescription = (event) => {
        ...
        const text = _toDoModule__WEBPACK_IMPORTED_MODULE_1__.toDoModule.getDescriptionProjectItem(projectId, todoId);
        _displayController__WEBPACK_IMPORTED_MODULE_2__.displayController.toggleDescription(toDoNode, text);
    ...
    const deleteItem = (event) => {
        ...
        _storage__WEBPACK_IMPORTED_MODULE_3__.storageController.removeFromProject(projectId, todoId);
    ...
    const renderEditItemForm = (event) => {
        ...
        const formattedDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(toDoItem.getDueDate(), 1), "yyyy-MM-dd");
    ...
    const editItem = (todoId, projectId, form) => {
        ...
        _storage__WEBPACK_IMPORTED_MODULE_3__.storageController.editToDoInProject(projectId, todoId, item);
